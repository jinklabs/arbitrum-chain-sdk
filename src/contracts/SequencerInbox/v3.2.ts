...
export const sequencerInboxABI = [
  {
    ...
    inputs: [
      ...
      { name: '_isDelayBufferable', internalType: 'bool', type: 'bool' },
    ],
  },
  ...
  { type: 'error', inputs: [], name: 'BadBufferConfig' },
  ...
  { type: 'error', inputs: [], name: 'CannotSetFeeTokenPricer' },
  ...
  { type: 'error', inputs: [], name: 'DelayProofRequired' },
  { type: 'error', inputs: [], name: 'DelayedBackwards' },
  { type: 'error', inputs: [], name: 'DelayedTooFar' },
  { type: 'error', inputs: [], name: 'Deprecated' },
  { type: 'error', inputs: [], name: 'ExtraGasNotUint64' },
  ...
  { type: 'error', inputs: [], name: 'InvalidDelayedAccPreimage' },
  {
    type: 'error',
    inputs: [{ name: '', internalType: 'bytes1', type: 'bytes1' }],
    name: 'InvalidHeaderFlag',
  },
  { type: 'error', inputs: [], name: 'KeysetTooLarge' },
  ...
  { type: 'error', inputs: [], name: 'NotDelayBufferable' },
  ...
  { type: 'error', inputs: [], name: 'RollupNotChanged' },
  {
    ...
    anonymous: false,
    inputs: [
      { name: 'newBatchPosterManager', internalType: 'address', type: 'address', indexed: false },
    ],
  ...
  },
  {
    ...
    anonymous: false,
    inputs: [
      { name: 'batchPoster', internalType: 'address', type: 'address', indexed: false },
      { name: 'isBatchPoster', internalType: 'bool', type: 'bool', indexed: false },
    ],
    name: 'BatchPosterSet',
  },
  {
  ...
  },
  {
    type: 'event',
    anonymous: false,
    inputs: [{ name: 'feeTokenPricer', internalType: 'address', type: 'address', indexed: false }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'isSequencer', internalType: 'bool', type: 'bool', indexed: false },
    ],
    name: 'SequencerSet',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'newMessageCount', internalType: 'uint256', type: 'uint256' },
      {
        ...
        type: 'tuple',
        components: [
          { name: 'beforeDelayedAcc', internalType: 'bytes32', type: 'bytes32' },
          {
            name: 'delayedMessage',
            ...
            components: [
              ...
              { name: 'inboxSeqNum', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'buffer',
    outputs: [
      { name: 'bufferBlocks', internalType: 'uint64', type: 'uint64' },
      { name: 'max', internalType: 'uint64', type: 'uint64' },
      { name: 'threshold', internalType: 'uint64', type: 'uint64' },
      { name: 'prevBlockNumber', internalType: 'uint64', type: 'uint64' },
      { name: 'replenishRateInBasis', internalType: 'uint64', type: 'uint64' },
      { name: 'prevSequencedBlockNumber', internalType: 'uint64', type: 'uint64' },
    ],
  },
  {
    stateMutability: 'view',
  ...
  },
  {
    ...
    inputs: [],
    name: 'feeTokenPricer',
    outputs: [{ name: '', internalType: 'contract IFeeTokenPricer', type: 'address' }],
  },
  {
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'feeTokenPricer_', internalType: 'contract IFeeTokenPricer', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
  },
